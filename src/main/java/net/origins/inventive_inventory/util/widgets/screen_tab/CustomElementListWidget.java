...
public abstract class CustomElementListWidget<E extends CustomElementListWidget.CustomEntry<E>> extends CustomEntryListWidget<E> {
    ...
    public CustomElementListWidget(MinecraftClient client, int width, int height, int y, int itemHeight) {
    ...
    @Environment(EnvType.CLIENT)
    public abstract static class CustomEntry<E extends CustomEntry<E>> extends CustomEntryListWidget.CustomEntry<E> implements ParentElement {
        @Nullable
