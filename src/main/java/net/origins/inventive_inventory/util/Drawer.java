...
public class Drawer {
    ...
    public static void drawTexture(DrawContext context, Identifier texture, int x, int y, int z, int size) {
        context.drawTexture(RenderLayer::get, texture, x, y, z, 0, 0, size, size, size, size);
    }

    public static void drawProfileHotbar(DrawContext context, int x, int y) {
        context.drawGuiTexture(RenderLayer::getGuiTextured, Textures.HOTBAR, 205, 20, 0, 0, x, y, 205, 20);//Texture(RenderLayer::getGuiTextured, Textures.HOTBAR, x, y, 0, 0, 0, 205, 20, 205, 20);
    ...
    public static void drawLockedSlot(DrawContext context, int x, int y) {
        context.drawTexture(RenderLayer::getGuiTextured, Textures.SLOT, x, y, 0, 0, 0, 20, 20, 20, 20);
