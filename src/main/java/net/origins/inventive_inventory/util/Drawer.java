...
public class Drawer {
    ...
    public static void drawProfileHotbar(DrawContext context, int x, int y) {
        context.drawTexture(RenderLayer::getGuiTextured, Textures.HOTBAR, x, y, 0, 0, 205, 20, 205, 20);//Texture(RenderLayer::getGuiTextured, Textures.HOTBAR, x, y, 0, 0, 0, 205, 20, 205, 20);
    ...
    public static void drawLockedSlot(DrawContext context, int x, int y) {
        context.drawTexture(RenderLayer::getGuiTextured, Textures.SLOT, x, y, 0, 0, 20, 20, 20, 20);
